...
#
#                       
#                       Prevendo a Inadimplencia de Clientes
#
#*****************************************************************************

# Definindo a pasta de trabalho
getwd()
setwd("C:/Users/rafaj/Desktop/Curso PowerBI/Cap10")
...
View(dataset)
str(dataset)  # Resumo de todas as variaveis
head(dataset) # verificando as primeiras linhas
